...
class CalendarService(
  ...
  fun sendSms(
    ...
    } catch (ne: NotificationClientException) {
      telemetryService.trackEvent("AppointmentReminderFailure", telemetryProperties)
      telemetryService.trackException(ne, telemetryProperties)
    } catch (ia: IllegalArgumentException) {
      telemetryService.trackEvent("IllegalArgumentException", telemetryProperties)
      telemetryService.trackException(ia, telemetryProperties)
    } catch (op: OptimisticLockingFailureException) {
      telemetryService.trackEvent("IllegalArgumentException", telemetryProperties)
      telemetryService.trackException(op, telemetryProperties)
    } catch (e: Exception) {
      telemetryService.trackEvent("Exception", telemetryProperties)
